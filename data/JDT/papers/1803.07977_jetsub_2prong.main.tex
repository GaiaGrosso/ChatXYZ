...
%\section{PERFORMANCE VERSUS ROBUSTNESS:  \\ TWO-PRONG SUBSTRUCTURE TAGGERS FOR THE LHC
...
%    Section coordinators:
    ...
    B.~Nachman,
    G.~Soyez,
    J.~Thaler (section coordinators); %}$^{,}$~\protect\footnote{
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Quantifying Performance and Robustness}\label{sec:SM_jetsub_2prong:pres}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.75\columnwidth]{plots/jetsub_2prong_realism_levels}
\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.9\columnwidth]{plots/jetsub_2prong_roc_to_significance}
\end{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Grooming Techniques}\label{sec:SM_jetsub_2prong:groom_tech}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Associated with the SoftDrop algorithm, in Sec.~\ref{sec:SM_jetsub_2prong:polar} we will study the observable $z_g$ as a means for performing polarimetry.
%
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.5\columnwidth]{plots/jetsub_2prong_dichroic-illust}
\end{center}
...
While our general approach is based on studying the different classes of grooming strategies in Table~\ref{tab:SM_jetsub_2prong:tag_summary}, for each of these different classes of strategies we will also scan different parameters.
%
...
\begin{figure}
  \centering{\includegraphics[width=0.4\textwidth]{plots/jetsub_2prong_mass-distribs.pdf}}
  %
...
\begin{figure}
\subfloat[]{
  \includegraphics[width=0.315\textwidth,page=1]{plots/jetsub_2prong_shape-distribs.pdf}
}
\subfloat[]{
  \includegraphics[width=0.315\textwidth,page=2]{plots/jetsub_2prong_shape-distribs.pdf}
}
\subfloat[]{
  \includegraphics[width=0.315\textwidth,page=3]{plots/jetsub_2prong_shape-distribs.pdf}
}
...
\begin{figure}
  \centering{\includegraphics[width=0.4\textwidth]{plots/jetsub_2prong_rocs.pdf}}
  %
...
\begin{figure}
\begin{center}
\includegraphics[width=0.4\columnwidth]{plots/jetsub_2prong_sweep_pt}
\end{center}
...
\begin{figure}
\subfloat[]{
  \includegraphics[width=0.315\textwidth,page=3]{plots/jetsub_2prong_grooming-scan.pdf}
}
\subfloat[]{
  \includegraphics[width=0.315\textwidth,page=1]{plots/jetsub_2prong_grooming-scan.pdf}
}
\subfloat[]{\label{fig:SM_jetsub_2prong:grooming-hadronisation:c}
  \includegraphics[width=0.315\textwidth,page=5]{plots/jetsub_2prong_grooming-scan.pdf}
}
...
\begin{figure}
\subfloat[]{
  \includegraphics[width=0.315\textwidth,page=5]{plots/jetsub_2prong_shape-scan.pdf}
}
\subfloat[]{
  \includegraphics[width=0.315\textwidth,page=3]{plots/jetsub_2prong_shape-scan.pdf}
}
\subfloat[]{
  \includegraphics[width=0.315\textwidth,page=1]{plots/jetsub_2prong_shape-scan.pdf}
}
...
In Figs.~\ref{fig:SM_jetsub_2prong:grooming-hadronisation} and
...
\begin{figure}
\subfloat[]{
  \includegraphics[width=0.315\textwidth,page=4]{plots/jetsub_2prong_grooming-scan.pdf}
}
\subfloat[]{
  \includegraphics[width=0.315\textwidth,page=2]{plots/jetsub_2prong_grooming-scan.pdf}
}
\subfloat[]{\label{fig:SM_jetsub_2prong:grooming-UE:c}
  \includegraphics[width=0.315\textwidth,page=6]{plots/jetsub_2prong_grooming-scan.pdf}
}
...
\begin{figure}
\subfloat[]{
  \includegraphics[width=0.315\textwidth,page=6]{plots/jetsub_2prong_shape-scan.pdf}
 }
\subfloat[]{
  \includegraphics[width=0.315\textwidth,page=4]{plots/jetsub_2prong_shape-scan.pdf}
}
\subfloat[]{
  \includegraphics[width=0.315\textwidth,page=2]{plots/jetsub_2prong_shape-scan.pdf}
}
...
\begin{figure}
\begin{center}
\subfloat[]{\label{fig:SM_jetsub_2prong:unsoftdropped}
\includegraphics[width=7cm]{plots/jetsub_2prong_optimal_pt_500}    
}\qquad
\subfloat[]{\label{fig:SM_jetsub_2prong:softdropped}
\includegraphics[width=7cm]{plots/jetsub_2prong_optimal_pt_1000}
}
\end{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Detector Models}\label{sec:SM_jetsub_2prong:det_model}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{center}
\subfloat[]{
\includegraphics[width=0.48\columnwidth]{plots/jetsub_2prong_jets_in_atlas}
}
\subfloat[]{
\includegraphics[width=0.48\columnwidth]{plots/jetsub_2prong_jets_in_cms}
}
\end{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Impact on Mass Resolution}\label{sec:SM_jetsub_2prong:detector_robust}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}
\subfloat[]{\label{fig:SM_jetsub_2prong:mass-detector:a}
  \includegraphics[width=0.45\columnwidth]{plots/jetsub_2prong_mass-detector.pdf}
}
\subfloat[]{\label{fig:SM_jetsub_2prong:mass-detector:b}
  \includegraphics[width=0.45\columnwidth]{plots/jetsub_2prong_mass-width-detector.pdf}
}
...
In Fig.~\ref{fig:SM_jetsub_2prong:mass-detector}, we show distributions
...
\begin{figure}
\begin{center}
\subfloat[]{\label{fig:SM_jetsub_2prong:polarization_dist}
\includegraphics[width=0.4\columnwidth]{plots/jetsub_2prong_D2_polarization}
}
\subfloat[]{\label{fig:SM_jetsub_2prong:polarization_roc}
\includegraphics[width=0.4\columnwidth]{plots/jetsub_2prong_polarisation-basic-rocs}
}
\end{center}
...
In Fig.~\ref{fig:SM_jetsub_2prong:polarization_dist}, we show the $D_2$ observable as measured on longitudinal and transverse hadronically-decaying W bosons, as well as the Standard Model mixture, as a representative example of the dependence of a two-prong tagger on polarization.
%
...
\begin{figure}
\begin{center}
\subfloat[]{\label{fig:SM_jetsub_2prong:z_g_dist}
\includegraphics[width=0.45\columnwidth]{plots/jetsub_2prong_polarisation-zg-distrib}
}
\subfloat[]{\label{fig:SM_jetsub_2prong:z_g_roc}
\includegraphics[width=0.45\columnwidth]{plots/jetsub_2prong_polarisation-zg-roc}
}
\end{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Summary and Recommendations}\label{sec:SM_jetsub_2prong:conc}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
