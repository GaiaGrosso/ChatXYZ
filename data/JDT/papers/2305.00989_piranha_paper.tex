...
\include{includes/utils/paper_preamble}
\include{includes/utils/piranha_utils}
\include{includes/utils/comments}
...
%
Most jet grooming techniques introduce hard cutoffs to remove soft radiation, leading to discontinuous behavior and associated experimental and theoretical challenges.
%
In this paper, we introduce Pileup and Infrared Radiation Annihilation (\PIRANHA{}), a paradigm for continuous jet grooming that overcomes the discontinuity and infrared sensitivity of hard-cutoff grooming procedures.
%
We motivate \PIRANHA{} from the perspective of optimal transport and the Energy Mover's Distance and review Apollonius Subtraction and Iterated Voronoi Subtraction as examples of \PIRANHA{}-style grooming.
%
We then introduce a new tree-based implementation of \PIRANHA{}, Recursive Subtraction, with reduced computational costs.
%
Finally, we demonstrate the performance of Recursive Subtraction in mitigating sensitivity to soft distortions from hadronization and detector effects, and additive contamination from pileup and the underlying event.
}
...
\iflistcomments
    \include{includes/aux/paper_comments}
\fi
...
% Buildup
%   Jet Substructure
%   Soft Distortions and Additive Contamination
%   Jet Grooming and Discontinuity
%   Discontinuity and Sensitivity
% Introduce \PIRANHA{}: In this paper we...
% Elaboration
%   Discontinuities of Hard Cutoffs
%   Soft cutoffs and \PIRANHA{}
%   Soft Continuity of \PIRANHA{}
%   Angular Discontinuity of Tree-Based
...
% Jet substructure
%--------------------------------
Jets of hadrons produced in high-energy particle collisions are an important guide in our understanding of the subatomic universe and quantum chromodynamics (QCD), our fundamental theory of the strong nuclear force.
%
...
% Event visualization
% Ungroomed
  \node at (1.8,  -5.0)() {\includegraphics[width=.25\textwidth]{figures/event_visualizations/vis_raw_1}};
  \node at (1.8,  -9.0)() {\includegraphics[width=.25\textwidth]{figures/event_visualizations/vis_raw_2}};
% mMDT
  \node at (6.5,  -5.0)() {\includegraphics[width=.25\textwidth]{figures/event_visualizations/vis_mmdt_1}};
  \node at (6.5,  -9.0)() {\includegraphics[width=.25\textwidth]{figures/event_visualizations/vis_mmdt_2}};
% P-RSF_1/2
  \node at (11.3,  -5.0)() {\includegraphics[width=.25\textwidth]{figures/event_visualizations/vis_rsf_half_1}};
  \node at (11.3,  -9.0)() {\includegraphics[width=.25\textwidth]{figures/event_visualizations/vis_rsf_half_2}};
...
\begin{tikzpicture}
\node at (0,0) {
    \includegraphics[width=0.45\textwidth]{figures/cartoons/space_pu}
};
...
\begin{tikzpicture}
\node at (0,0) {
\includegraphics[width=0.45\textwidth]{figures/event_visualizations/apollonius_diagram_pink}
};
...
\begin{figure}[t!]
      ...
      \begin{tikzpicture}
          \node at (0,0) {
              \includegraphics[width=.4\textwidth]{figures/cartoons/RSF_half_vis.pdf}
          };
      ...
      \begin{tikzpicture}
          \node at (0,0) {
              \includegraphics[width=.4\textwidth]{figures/cartoons/RSF_1_vis.pdf}
          };
...
\begin{figure}[t!]
      \centering
      \subfloat[]{
          \includegraphics[width=.4\textwidth]{figures/cartoons/angular_discont_left}
          \label{fig:ang_discont_left}
      }
      ~~~~
      \subfloat[]{
          \includegraphics[width=.4\textwidth]{figures/cartoons/angular_discont_right}
...
\subfloat[][]{
      ...
      {figures/responses/pvh/emd_dist-ph}
      \label{fig:ph_emd_dist}
}
\subfloat[][]{
      \includegraphics[width=.32\textwidth]
      {figures/responses/pvh/deltaemd-ph}
      \label{fig:ph_emd_delta}
}
\subfloat[][]{
      \includegraphics[width=.32\textwidth]
      {figures/responses/pvh/sigmaemd-ph}
      \label{fig:ph_emd_sigma}
}
\\
\subfloat[][]{
      \includegraphics[width=.32\textwidth]
      {figures/responses/pvh/delta_pt_dist-ph}
      \label{fig:ph_pt_dist}
}
\subfloat[][]{
      \includegraphics[width=.32\textwidth]
      {figures/responses/pvh/deltapt-ph}
      \label{fig:ph_pt_delta}
}
\subfloat[][]{
      \includegraphics[width=.32\textwidth]
      {figures/responses/pvh/sigmapt-ph}
      \label{fig:ph_pt_sigma}
}
\\
\subfloat[][]{
      \includegraphics[width=.32\textwidth]
      {figures/responses/pvh/deltac12_dist-ph}
      \label{fig:ph_c12_dist}
}
\subfloat[][]{
      \includegraphics[width=.32\textwidth]
      {figures/responses/pvh/deltac12-ph}
      \label{fig:ph_c12_delta}
}\subfloat[][]{
      \includegraphics[width=.32\textwidth]
      {figures/responses/pvh/sigmac12-ph}
...
\subfloat[][]{
      \includegraphics[width=.32\textwidth]
      {figures/responses/avc/emd_dist-avc}
      \label{fig:avc_emd_dist}
}
\subfloat[][]{
      \includegraphics[width=.32\textwidth]
      {figures/responses/avc/deltaemd-avc}
      \label{fig:avc_emd_delta}
}
\subfloat[][]{
      \includegraphics[width=.32\textwidth]
      {figures/responses/avc/sigmaemd-avc}
      \label{fig:avc_emd_sigma}
}
\\
\subfloat[][]{
      \includegraphics[width=.32\textwidth]
      {figures/responses/avc/delta_pt_dist-avc}
      \label{fig:avc_pt_dist}
}
\subfloat[][]{
      \includegraphics[width=.32\textwidth]
      {figures/responses/avc/deltapt-avc}
      \label{fig:avc_pt_delta}
}
\subfloat[][]{
      \includegraphics[width=.32\textwidth]
      {figures/responses/avc/sigmapt-avc}
      \label{fig:avc_pt_sigma}
}
\\
\subfloat[][]{
      \includegraphics[width=.32\textwidth]
      {figures/responses/avc/deltac12_dist-avc}
      \label{fig:avc_c12_dist}
}
\subfloat[][]{
      \includegraphics[width=.32\textwidth]
      {figures/responses/avc/deltac12-avc}
      \label{fig:avc_c12_delta}
}
\subfloat[][]{
      \includegraphics[width=.32\textwidth]
      {figures/responses/avc/sigmac12-avc}
...
\subfloat[][]{
      \includegraphics[width=.32\textwidth]
      {figures/responses/pileup/main_emd_npu50}
      \label{fig:pu_emd_dist}
}
\subfloat[][]{
      \includegraphics[width=.32\textwidth]
      {figures/responses/pileup/main_emd_npu_shifts}
      \label{fig:pu_emd_shift}
}
\subfloat[][]{
      \includegraphics[width=.32\textwidth]
      {figures/responses/pileup/main_emd_npu_stds}
...
\subfloat[][]{
      \includegraphics[width=.32\textwidth]
      {figures/responses/pileup/main_dpt_npu50}
      \label{fig:pu_pt_dist}
}
\subfloat[][]{
      \includegraphics[width=.32\textwidth]
      {figures/responses/pileup/main_dpt_npu_shifts}
      \label{fig:pu_pt_shift}
}
\subfloat[][]{
      \includegraphics[width=.32\textwidth]
      {figures/responses/pileup/main_dpt_npu_stds}
      \label{fig:pu_pt_std}
}
} % centerline
~\\
...
\subfloat[][]{
      \includegraphics[width=.32\textwidth]
      {figures/responses/pileup/main_dc1_npu50}
      \label{fig:pu_c12_dist}
}
\subfloat[][]{
      \includegraphics[width=.32\textwidth]
      {figures/responses/pileup/main_dc1_npu_shifts}
      \label{fig:pu_c12_shift}
}
\subfloat[][]{
      \includegraphics[width=.32\textwidth]
      {figures/responses/pileup/main_dc1_npu_stds}
...
\centering
    \subfloat[][]{
        \includegraphics[width=.45\textwidth]{figures/responses/ue/c12_ratio_plots/rsf_half_zbase0.0_ratio_maintext}
\label{fig:rss_ue_0}
    }
    \subfloat[][]{
        \includegraphics[width=.45\textwidth]{figures/responses/ue/c12_ratio_plots/rsf_half_zbase0.025_ratio_maintext}
\label{fig:rss_ue_025}
    }
    \\
    \subfloat[][]{
        \includegraphics[width=.45\textwidth]{figures/responses/ue/c12_ratio_plots/sd2_zbase0.0_ratio_maintext}
\label{fig:sd_ue_0}
    }
    \subfloat[][]{
        \includegraphics[width=.45\textwidth]{figures/responses/ue/c12_ratio_plots/sd2_zbase0.025_ratio_maintext}
\label{fig:sd_ue_025}
    }
\caption{
...
\centerline{
    \subfloat[][]{
        \includegraphics[width=.48\textwidth]{figures/responses/ue/wassersteins/wdists_maintype_correctedFalse}
\label{fig:ue_wasser_nocorrection}
    }
    \subfloat[][]{
        \includegraphics[width=.48\textwidth]{figures/responses/ue/wassersteins/wdists_maintype_correctedTrue}
...
\centering
\subfloat[][]{
\includegraphics[width=.45\textwidth]{figures/responses/mass_resolution/w_mass_resolution}
\label{fig:w_tagging_dist}
}
\subfloat[][]{
\includegraphics[width=.45\textwidth]{figures/responses/mass_resolution/w_mass_roc}
\label{fig:w_tagging_roc}
}
\\
\subfloat[][]{
\includegraphics[width=.45\textwidth]{figures/responses/mass_resolution/top_mass_resolution}
\label{fig:top_tagging_dist}
}
\subfloat[][]{
\includegraphics[width=.45\textwidth]{figures/responses/mass_resolution/top_mass_roc}
...
\begin{figure}[p]
    \centering
    \subfloat[]{
        \includegraphics[width=.32\textwidth]{figures/feeding_frenzy/pvh/sigmaemdsdtype-ph}
    }
    \subfloat[]{
        \includegraphics[width=.32\textwidth]{figures/feeding_frenzy/pvh/sigmaemdpiratype-ph}
    }
    \subfloat[]{
        \includegraphics[width=.32\textwidth]{figures/feeding_frenzy/pvh/sigmaemdrsftype-ph}
    }
    \\
    \subfloat[]{
        \includegraphics[width=.32\textwidth]{figures/feeding_frenzy/pvh/sigmaptsdtype-ph}
    }
    \subfloat[]{
        \includegraphics[width=.32\textwidth]{figures/feeding_frenzy/pvh/sigmaptpiratype-ph}
    }
    \subfloat[]{
        \includegraphics[width=.32\textwidth]{figures/feeding_frenzy/pvh/sigmaptrsftype-ph}
    }
    \\
    \subfloat[]{
        \includegraphics[width=.32\textwidth]{figures/feeding_frenzy/pvh/sigmac12sdtype-ph}
    }
    \subfloat[]{
        \includegraphics[width=.32\textwidth]{figures/feeding_frenzy/pvh/sigmac12piratype-ph}
    }
    \subfloat[]{
        \includegraphics[width=.32\textwidth]{figures/feeding_frenzy/pvh/sigmac12rsftype-ph}
    }
\caption{
...
\begin{figure}[p]
    \subfloat[]{
        \includegraphics[width=.32\textwidth]{figures/feeding_frenzy/avc/sigmaemdsdtype-avc}
    }
    \subfloat[]{
        \includegraphics[width=.32\textwidth]{figures/feeding_frenzy/avc/sigmaemdpiratype-avc}
    }
    \subfloat[]{
        \includegraphics[width=.32\textwidth]{figures/feeding_frenzy/avc/sigmaemdrsftype-avc}
    }
    \\
    \subfloat[]{
        \includegraphics[width=.32\textwidth]{figures/feeding_frenzy/avc/sigmaptsdtype-avc}
    }
    \subfloat[]{
        \includegraphics[width=.32\textwidth]{figures/feeding_frenzy/avc/sigmaptpiratype-avc}
    }
    \subfloat[]{
        \includegraphics[width=.32\textwidth]{figures/feeding_frenzy/avc/sigmaptrsftype-avc}
    }
    \\
    \subfloat[]{
        \includegraphics[width=.32\textwidth]{figures/feeding_frenzy/avc/sigmac12sdtype-avc}
    }
    \subfloat[]{
        \includegraphics[width=.32\textwidth]{figures/feeding_frenzy/avc/sigmac12piratype-avc}
    }
    \subfloat[]{
        \includegraphics[width=.32\textwidth]{figures/feeding_frenzy/avc/sigmac12rsftype-avc}
    }
\caption{
...
\begin{figure}[t!]
    ...
    \subfloat[]{
        ...
        {figures/temp/tempfig}
        \label{fig:epochcorrectionfactor}
    }
    \subfloat[]{
        \includegraphics[width=.48\textwidth]
        {figures/temp/tempfig}
        \label{fig:epochdeltapt}
    }
\caption{
Plots demonstrating the changes in PU-correction for each groomer as a function of the epoch of the optimization procedure described in the text.
%
\Fig{epochcorrectionfactor} shows how the correction factors of \Eq{epochcorrectionfactor} change as a function of the epoch, while \Fig{epochdeltapt} demonstrates that \(|\Delta p_T| = |p_T^{\rm(groomed PU)} - p_T^{\rm(hard)}|\) decreases as the epoch increases and we better optimize the PU-subtraction for each groomer.
}
\label{fig:pulearning}
\end{figure}


\Figs{epochcorrectionfactor}{epochdeltapt} examine the way that correction factors and \(\langle \Delta p_T\rangle = p_T^{\rm(groomed PU)} - p_T^{\rm(hard)}\) of our PU optimization procedure change as a function of the epoch, respectively.
%
The way that \(|\langle \Delta p_T\rangle|\) decreases as a function of the epoch of optimization in \Fig{epochdeltapt} in particular demonstrates how the tuning of our correction factors leads to better PU-subtraction for each groomer.
\fi
...
\centering
    \subfloat[]{
        \includegraphics[width=.32\textwidth]
        {figures/feeding_frenzy/pu/sdtype_emd_npu_shifts}
    }
    \subfloat[]{
        \includegraphics[width=.32\textwidth]
        {figures/feeding_frenzy/pu/piratype_emd_npu_shifts}
    }
    \subfloat[]{
        \includegraphics[width=.32\textwidth]
        {figures/feeding_frenzy/pu/rsftype_emd_npu_shifts}
    }
    \\
    \subfloat[]{
        \includegraphics[width=.32\textwidth]
        {figures/feeding_frenzy/pu/sdtype_dpt_npu_shifts}
    }
    \subfloat[]{
        \includegraphics[width=.32\textwidth]
        {figures/feeding_frenzy/pu/piratype_dpt_npu_shifts}
    }
    \subfloat[]{
        \includegraphics[width=.32\textwidth]
        {figures/feeding_frenzy/pu/rsftype_dpt_npu_shifts}
    }
    \\
    \subfloat[]{
        \includegraphics[width=.32\textwidth]
        {figures/feeding_frenzy/pu/sdtype_dc1_npu_shifts}
    }
    \subfloat[]{
        \includegraphics[width=.32\textwidth]
        {figures/feeding_frenzy/pu/piratype_dc1_npu_shifts}
    }
    \subfloat[]{
        \includegraphics[width=.32\textwidth]
        {figures/feeding_frenzy/pu/rsftype_dc1_npu_shifts}
    }
\caption{
...
\centering
    \subfloat[]{
        \includegraphics[width=.32\textwidth]
        {figures/feeding_frenzy/pu/sdtype_emd_npu_stds}
    }
    \subfloat[]{
        \includegraphics[width=.32\textwidth]
        {figures/feeding_frenzy/pu/piratype_emd_npu_stds}
    }
    \subfloat[]{
        \includegraphics[width=.32\textwidth]
        {figures/feeding_frenzy/pu/rsftype_emd_npu_stds}
    }
    \\
    \subfloat[]{
        \includegraphics[width=.32\textwidth]
        {figures/feeding_frenzy/pu/sdtype_dpt_npu_stds}
    }
    \subfloat[]{
        \includegraphics[width=.32\textwidth]
        {figures/feeding_frenzy/pu/piratype_dpt_npu_stds}
    }
    \subfloat[]{
        \includegraphics[width=.32\textwidth]
        {figures/feeding_frenzy/pu/rsftype_dpt_npu_stds}
    }
    \\
    \subfloat[]{
        \includegraphics[width=.32\textwidth]
        {figures/feeding_frenzy/pu/sdtype_dc1_npu_stds}
    }
    \subfloat[]{
        \includegraphics[width=.32\textwidth]
        {figures/feeding_frenzy/pu/piratype_dc1_npu_stds}
    }
    \subfloat[]{
        \includegraphics[width=.32\textwidth]
        {figures/feeding_frenzy/pu/rsftype_dc1_npu_stds}
    }
\caption{
...
\begin{figure}[t!]
    \subfloat[]{
        \includegraphics[width=.5\textwidth]{figures/feeding_frenzy/runtime/runtimes_npu50}
    }
    \subfloat[]{
        \includegraphics[width=.5\textwidth]{figures/feeding_frenzy/runtime/average_runtimes}
    }
    \caption{
...
\begin{figure}[p]
    \centering
    \subfloat[]{
        \includegraphics[width=.32\textwidth]{figures/responses/ue/wassersteins/wdists_sdtype_correctedFalse}
        \label{fig:uefrenzy_wasserstein_sd}
    }
    \subfloat[]{
        \includegraphics[width=.32\textwidth]{figures/responses/ue/wassersteins/wdists_piratype_correctedFalse}
        \label{fig:uefrenzy_wasserstein_pira}
    }
    \subfloat[]{
        \includegraphics[width=.32\textwidth]{figures/responses/ue/wassersteins/wdists_rsftype_correctedFalse}
    }
    \\
    \subfloat[]{
        \includegraphics[width=.32\textwidth]{figures/responses/ue/wassersteins/wdists_sdtype_correctedTrue}
        \label{fig:uefrenzy_correctedwasserstein_sd}
    }
    \subfloat[]{
        \includegraphics[width=.32\textwidth]{figures/responses/ue/wassersteins/wdists_piratype_correctedTrue}
        \label{fig:uefrenzy_correctedwasserstein_pira}
    }
    \subfloat[]{
        \includegraphics[width=.32\textwidth]{figures/responses/ue/wassersteins/wdists_rsftype_correctedTrue}
    }
    \\
    \subfloat[]{
        \includegraphics[width=.32\textwidth]{figures/responses/ue/delta_zcuts/zcuts_sdtype}
    \label{fig:uefrenzy_deltazcut_sd}
    }
    \subfloat[]{
        \includegraphics[width=.32\textwidth]{figures/responses/ue/delta_zcuts/zcuts_piratype}
    \label{fig:uefrenzy_deltazcut_pira}
    }
    \subfloat[]{
        \includegraphics[width=.32\textwidth]{figures/responses/ue/delta_zcuts/zcuts_rsftype}
    }
\caption{
...
% Soft Drop, LL
\subfloat[]{
\includegraphics[width=.48\textwidth]{figures/resummed_plots/C12_SD0_LL}
\label{fig:LL_SD0}
}
%
% Soft Drop, MLL
\subfloat[]{
\includegraphics[width=.48\textwidth]{figures/resummed_plots/C12_SD0_MLL}
\label{fig:MLL_SD0}
}
\\
%
% \PRSF{1}, LL
\subfloat[]{
\includegraphics[width=.48\textwidth]{figures/resummed_plots/C12_PRSF1_LL}
\label{fig:LL_PRSF1}
}
%
% \PRSF{1}, MLL
\subfloat[]{
\includegraphics[width=.48\textwidth]{figures/resummed_plots/C12_PRSF1_MLL}
\label{fig:MLL_PRSF1}
}
\caption{
